Public Class FrmBilling
    ...
    Public Sub LoadRecords()
        Query("SELECT a.ID, a.EID, b.LRN, CONCAT(b.Lastname, ' ', b.Firstname, ' ', b.MiddleInitial) Fullname, c.SectionRoom, d.GradeLevel, a.SchoolYear, 
    ...
    Private Sub DgvBilling_DoubleClick(sender As Object, e As EventArgs) Handles dgvBilling.DoubleClick
        If dgvBilling.SelectedRows.Count > 0 Then
            With dgvBilling.SelectedRows(0)
                ...
                FrmFee.LabelEID.Text = .Cells(1).Value
                FrmFee.txtLRN.Text = .Cells(2).Value
                FrmFee.txtStudName.Text = .Cells(3).Value
                FrmFee.txtGradeLvl.Text = .Cells(4).Value
                FrmFee.txtSection.Text = .Cells(5).Value
                FrmFee.LabelSY.Text = .Cells(6).Value
            End With
